...
import { NIGHT_POSTS } from "./nightArticle";
import { VINTAGE_POSTS } from "./vintageArticle";
import { ELEGANT_POSTS } from "./elegantArticle";
import { PARK_POSTS } from "./parkGardenArticle";
import { COFFEE_POSTS } from "./coffeeShopArticle";
import { ROMANTIC_POSTS } from "./romanticArticle";
import { ANNOUNCEMENT_POSTS } from "./engagementAnnouncementArticle";
import { ENGAGEMENT_CHECKLIST_POSTS } from "./engagementPhotoChecklistArticle";
...
const ALL: Post[] = [
  ...
  ...CANDID_POSTS, ...FUN_POSTS, ...CUTE_POSTS, ...NIGHT_POSTS, ...VINTAGE_POSTS, ...ELEGANT_POSTS, ...PARK_POSTS, ...COFFEE_POSTS, ...ROMANTIC_POSTS, ...ANNOUNCEMENT_POSTS, ...ENGAGEMENT_CHECKLIST_POSTS,
];
