...
export const KEYWORD_MAP: KeywordTarget[] = [
  ...
  { path: "/engagement-photo-ideas/vintage-engagement-photo-ideas", keyword: "vintage engagement photos", volume: 0, kd: 0, intent: "Informational", phase: 1 }, // volume à valider — spoke livré §10, source de volume non renseignée
  ...
  { path: "/engagement-photo-ideas/engagement-photo-checklist", keyword: "engagement photo checklist", volume: 0, kd: 0, intent: "Informational", phase: 1 }, // volume à valider — spoke §10 hors-ideas (hub ideas) ; atterrit overrides timeline + weather backup
