...
export const HUBS: Hub[] = [
  ...
  },
  {
    ...
    volume: "1,900/mo",
    kd: "14",
    metaTitle: "Engagement Photo Poses: 30+ Flattering Frames (2026)",
    metaDescription:
      "Engagement photo poses that flatter every couple — classic, fun and romantic frames with the exact direction photographers use on real sessions.",
    ...
    faq: [
      {
        ...
        a: "The forehead touch with eyes closed, walking away hand-in-hand, and the waist-hold mid-laugh. All three remove the pressure of performing for the lens and usually unlock the rest of the session.",
      },
      {
        q: "How long should we hold an engagement pose?",
        a: "About 10 seconds. The first 3 are stiff, the next 7 are gold. Your photographer should shoot the whole sequence, not just the setup, because the settle-in frames are the keepers.",
      },
      {
        q: "What do we do with our hands in engagement poses?",
        a: "Give them a job: a lapel, a waist, interlaced fingers, a coffee cup, a bouquet. Empty hands look awkward; busy hands look natural. A good photographer directs this explicitly.",
      },
    ],
  },
  {
