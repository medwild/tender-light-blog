          ...
          <div className="mt-10 grid gap-10 lg:grid-cols-12 lg:items-end">
            <Reveal delay={350} className="lg:col-span-6">
              ...
              <div className="mt-8 flex flex-wrap gap-4">
                ...
                <Link to="#latest" onClick={(e) => { e.preventDefault(); document.getElementById("latest")?.scrollIntoView({ behavior: "smooth" }); }} className="inline-flex items-center gap-2 rounded-full border border-ink px-7 py-3.5 text-sm font-semibold transition-all duration-300 hover:-translate-y-0.5 hover:bg-ink hover:text-cream">
                  Latest guides
                </Link>
              </div>
            </Reveal>
