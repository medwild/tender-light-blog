...
**Situation au 2026-09-04** : 51 articles, 62 URLs au sitemap, audit site-wide **0 problème** (FAILs §23, liens cassés, bans persona, B1/B2), typecheck + build verts. Série ideas close (candid, fun, cute, night, vintage, elegant) puis `park-garden-engagement-photo-ideas` (hub **locations**, 12 setups green géré, 2110 mots). Spokes récents sans ligne KEYWORD_MAP → 4e edit `volume: 0 // volume à valider`. Précédents : `candid` (`8f8d447`), `photo-booth-strip-ideas` (`9558080`), owners §23 `outdoor-engagement-photo-poses` + `save-the-date-poses` (`c863105`).
